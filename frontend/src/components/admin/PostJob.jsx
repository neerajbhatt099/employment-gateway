        ...
        <div>
            ...
            <div className='flex items-center justify-center w-screen my-5'>
                <form onSubmit={submitHandler} className='p-8 max-w-4xl border border-gray-200 shadow-lg rounded-md'>
                    ...
                    {
                        loading ? <Button className='w-full my-4'> <Loader2 className='mr-2 h-4 m-4 animate-spin' />Please wait</Button> : <Button type="submit" className='w-full my-4'>Post New Job</Button>
                    }
                    {
